...
namespace SwagBlogPlugin\Core\Content\productSlider\Cms;
...
#[Package('inventory')]
class ictechProductSliderCmsElementResolver extends AbstractCmsElementResolver
{
