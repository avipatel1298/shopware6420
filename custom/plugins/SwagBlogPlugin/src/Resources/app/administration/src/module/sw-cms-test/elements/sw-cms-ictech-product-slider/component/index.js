import template from'./sw-cms-ictech-el-product-slider.html.twig';
import './sw-cms-ictech-el-product-slider.scss';
 ...
 * @package content
 */
Component.register('sw-cms-ictech-el-product-slider', {
    template,
    ...
    methods: {
        createdComponent() {
            this.initElementConfig('ictech-product-slider');
            this.initElementData('ictech-product-slider');
        },
