...
namespace Flink\QuickView\Storefront\Controller;
...
class QuickViewController extends StorefrontController
{
     ...
     *
     * @RouteScope(scopes={"storefront"})
     * @Route("/flink/quickview/{productId}/switch", name="flink.quickview.switch", methods={"GET"}, defaults={"productId"=null, "XmlHttpRequest"=true})
     *
