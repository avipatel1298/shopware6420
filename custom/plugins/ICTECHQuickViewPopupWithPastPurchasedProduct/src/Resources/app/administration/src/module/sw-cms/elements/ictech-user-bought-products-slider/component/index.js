import template from'./sw-cms-el-ictech-user-bought-products-slider.html.twig';
import './sw-cms-el-ictech-user-bought-products-slider.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-ictech-user-bought-products-slider', {
    template,
    ...
    computed: {
        ...
        crossSelling() {
            if (!this.element.data.product || !this.element.data.product.crossSellings.length) {
                return {
                    name: 'User bought products slider',
                };
            }
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('ictech-user-bought-products-slider');
        },
