import template from './sw-cms-el-ictech-products-review-slider.html.twig';
import './sw-cms-el-ictech-products-review-slider.scss';
 ...
 * @package content
 */
Component.register('sw-cms-el-ictech-products-review-slider', {
    template,
    ...
    methods: {
        createdComponent() {
            ...
            this.initElementData('ictech-products-review-slider');
        },
